...
void
TestScene4::runPanda(int argc, char** argv)
{
...
TestScene4::runOsg()
{
	...
	// load & integrate model
	viewer->setSceneData(osgDB::readNodeFile("/home/soulmerge/projects/Diplomarbeit/Prototype/resources/Ogre/alexandria.3ds"));
	// loop
	runOsgLoop(viewer);
}
